                ...
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <ul class="nav nav-pills nav-justified" role="tablist">
                            ...
                            <li class="nav-item waves-effect waves-light">
                                <a class="nav-link" data-toggle="tab" href="#profile-1" role="tab">Cadastrar Bolo comprado</a>
                            </li>
                            <li class="nav-item waves-effect waves-light">
                                <a class="nav-link" data-toggle="tab" href="#profile-2" role="tab">Cadastrar Resgate</a>
                            </li>
                            <li class="nav-item waves-effect waves-light">
