function cadastrarFidelidadeAction() {
    ...
    soma = bolo_festa + bolo_pequeno + bolo_grande + bolo_recheado;

    if(tipo_bolo == 1) {
        if(bolo_pote == 9) {
            premio = 1;
        }
    } else if(soma >= 9 && tipo_bolo != 1) {
        var array = [bolo_festa,bolo_pequeno,bolo_grande,bolo_recheado];
        premio = biggestNumberInArray(array);
    }
